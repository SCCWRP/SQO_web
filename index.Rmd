  ...
  withProgress(
    ...
    value = 0, 
    {
      ...
      if(inptyp == 'File upload'){
        ...
        biota <<- input$biotaupl
        constants <<- input$constantsupl
        contam <<- input$contamupl
...
output$dlconsantstmpl <- downloadHandler(
  ...
  if(inptyp == 'File upload'){
    ...
    out <- div(
      column(12, 
        ...
        column(3, fileInput('biotaupl', NULL, accept = '.csv'))
      ), 
      column(12, 
        h3('Site and environmental data'),
        column(3, downloadButtonRmd('dlconstantstmpl', 'Download template')),
        column(3, fileInput('constantsupl', NULL, accept = '.csv'))
      ),
      column(12, 
        h3('Contaminants'), 
        column(3, downloadButtonRmd('dlcontamtmpl', 'Download template')),
        column(3, fileInput('contamupl', NULL, accept = '.csv'))
      ), 
      column(12,
        h3('MCS parameters'),
        column(3, downloadButtonRmd('dlmcsparmstmpl', 'Download template')),
        column(3, fileInput('mcsparmsupl', NULL, accept = '.csv'))
      )
    )
