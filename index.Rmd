...
selectInput('guild1', 'Select indicator species 1:', choices = indic_lookup[['Indicator species 1']])
selectInput('guild2', 'Select indicator species 2:', choices = indic_lookup[['Indicator species 2']])
selectInput('guild3', 'Select indicator species 3:', choices = indic_lookup[['Indicator species 3']])
selectInput('guild4', 'Select indicator species 4:', choices = indic_lookup[['Indicator species 4']])
selectInput('guild5', 'Select indicator species 5:', choices = indic_lookup[['Indicator species 5']])
selectInput('guild6', 'Select indicator species 6:', choices = indic_lookup[['Indicator species 6']])
selectInput('guild7', 'Select indicator species 7:', choices = indic_lookup[['Indicator species 7']])
selectInput('guild8', 'Select indicator species 8:', choices = indic_lookup[['Indicator species 8']])
selectInput('guild9', 'Select indicator species 9:', choices = indic_lookup[['Indicator species 9']])
...
```{r}
renderDataTable({bsaf_res()$BSAF})
```

## CBIOTA table

```{r}
renderDataTable({bsaf_res()$CBIOTA})
```
