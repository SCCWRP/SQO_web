...
wellPanel(id = "indicspec", style = "overflow-y:scroll; max-height: 300px; background-color:#daf1da",
  ...
  fluidRow(
    ...
    column(2, 'Portion of human seafood'),
    column(2, 'Lipid proportion')
  ),
...
<!-- ### Indicator guild species - tissue concentrations -->
<!-- ```{r} -->
<!-- # tssinp <- read.csv(here('data/tabinps', 'tissueinp.csv'), stringsAsFactors = F) -->
<!-- #  -->
<!-- # output$tssinptab <- renderDT({datatable(tssinp, editable = T)}) -->


<!-- wellPanel(id = "indicspec", style = "overflow-y:scroll; max-height: 300px; overflow-x:scroll; 2000px; background-color:#daf1da", -->

<!--   # headers -->
<!--   fluidRow( -->
<!--     column(4, NULL), -->
<!--     column(2, 'Chlordane (ng/g)'), -->
<!--     column(2, 'Dieldrin (ng/g)'), -->
<!--     column(2, 'DDT (ng/g)'), -->
<!--     column(2, 'PCB (ng/g)') -->
<!--   ), -->
...
<!--   # indic 1 -->
<!--   fluidRow( -->
<!--     column(4, renderUI({h6('1 Piscivore:', input$indic1)})), -->
<!--     column(1, numericInput('indic1chlormean', NULL, value = NULL, min = 0, width = '100%')), -->
<!--     column(1, numericInput('indic1chlorse', NULL, value = NULL, min = 0, width = '100%')), -->
<!--     column(1, numericInput('indic1dieldmean', NULL, value = NULL, min = 0, width = '100%')), -->
<!--     column(1, numericInput('indic1dieldse', NULL, value = NULL, min = 0, width = '100%')), -->
<!--     column(1, numericInput('indic1ddtmean', NULL, value = NULL, min = 0, width = '100%')), -->
<!--     column(1, numericInput('indic1ddtse', NULL, value = NULL, min = 0, width = '100%')), -->
<!--     column(1, numericInput('indic1pcbmean', NULL, value = NULL, min = 0, width = '100%')), -->
<!--     column(1, numericInput('indic1pcbse', NULL, value = NULL, min = 0, width = '100%')) -->
<!--   ), -->

<!--   # indic 2 -->
<!--   fluidRow( -->
<!--     column(4, renderUI({h6('2 Benthic diet with piscivory:', input$indic2)})), -->
<!--     column(2, numericInput('indic2seaf', NULL, value = 0.5, min = 0, max = 1)), -->
<!--     column(2, numericInput('indic2lip', NULL, value = 0.0044, min = 0, max = 1, width = '100%')) -->
<!--   ), -->
...
<!--   # indic 3 -->
<!--   fluidRow( -->
<!--     column(4, renderUI({h6('3 Benthic and pelagic with piscivory:', input$indic3)})), -->
<!--     column(2, numericInput('indic3seaf', NULL, value = 0, min = 0, max = 1)), -->
<!--     column(2, numericInput('indic3lip', NULL, value = 0.0158, min = 0, max = 1, width = '100%')) -->
<!--   ), -->
...
<!--   # indic 4 -->
<!--   fluidRow( -->
<!--     column(4, renderUI({h6('4 Benthic without piscivory:', input$indic4)})), -->
<!--     column(2, numericInput('indic4seaf', NULL, value = 0, min = 0, max = 1)), -->
<!--     column(2, numericInput('indic4lip', NULL, value = 0.0329, min = 0, max = 1, width = '100%')) -->
<!--   ), -->
...
<!--   # indic 5 -->
<!--   fluidRow( -->
<!--     column(4, renderUI({h6('5 Benthic and pelagic without piscivory:', input$indic5)})), -->
<!--     column(2, numericInput('indic5seaf', NULL, value = 0.5, min = 0, max = 1)), -->
<!--     column(2, numericInput('indic5lip', NULL, value = 0.0125, min = 0, max = 1, width = '100%')) -->
<!--   ), -->
...
<!--   # indic 6 -->
<!--   fluidRow( -->
<!--     column(4, renderUI({h6('6 Benthic with herbivory:', input$indic6)})), -->
<!--     column(2, numericInput('indic6seaf', NULL, value = 0, min = 0, max = 1)), -->
<!--     column(2, numericInput('indic6lip', NULL, value = 0.0356, min = 0, max = 1, width = '100%')) -->
<!--   ), -->
...
<!--   # indic 7 -->
<!--   fluidRow( -->
<!--     column(4, renderUI({h6('7 Benthic and pelagic with herbivory:', input$indic7)})), -->
<!--     column(2, numericInput('indic7seaf', NULL, value = 0, min = 0, max = 1)), -->
<!--     column(2, numericInput('indic7lip', NULL, value = 0.0117, min = 0, max = 1, width = '100%')) -->
<!--   ), -->
...
<!--   # indic 8 -->
<!--   fluidRow( -->
<!--     column(4, renderUI({h6('8 Pelagic with benthic herbivory:', input$indic8)})), -->
<!--     column(2, numericInput('indic8seaf', NULL, value = 0, min = 0, max = 1)), -->
<!--     column(2, numericInput('indic8lip', NULL, value = 0.0444, min = 0, max = 1, width = '100%')) -->
<!--   ), -->
...
<!--   # indic 9 -->
<!--   fluidRow( -->
<!--     column(4, renderUI({h6('9 Benthic diet with piscivory: estuarine:', input$indic9)})), -->
<!--     column(2, numericInput('indic9seaf', NULL, value = 0, min = 0, max = 1)), -->
<!--     column(2, numericInput('indic9lip', NULL, value = 0.0036, min = 0, max = 1, width = '100%')) -->
<!--   ) -->
