...
mcsparms <- read.csv('data/mcsparms.csv', stringAsFactors = F)
...
column(12, 
  ...
  #     downloadHandler(
  #       filename = function() {"bsaf.csv"},
  #       content = function(file) {
  #         write.csv(bsaf(), file, row.names = FALSE)
  #       }
  #     )
  #   # })
  # )
...
wellPanel(id = "indicspec", style = "overflow-x:scroll; background-color:#daf1da",
  ...
  fluidRow(
    ...
    splitLayout(cellWidths = wds,
      ...
      numericInput('indic1chlormean', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic1chlorse', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic1dieldmean', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic1dieldse', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic1ddtmean', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic1ddtse', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic1pcbmean', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic1pcbse', NULL, value = NULL, min = 0, width = '100%')
    )
  ),
  ...
  fluidRow(
    ...
    splitLayout(cellWidths = wds,
      ...
      numericInput('indic2chlormean', NULL, value = 2.0425, min = 0, width = '100%'),
      numericInput('indic2chlorse', NULL, value = 0.909979488352973, min = 0, width = '100%'),
      numericInput('indic2dieldmean', NULL, value = 0.25, min = 0, width = '100%'),
      numericInput('indic2dieldse', NULL, value = 0, min = 0, width = '100%'),
      numericInput('indic2ddtmean', NULL, value = 2.40733333333333, min = 0, width = '100%'),
      numericInput('indic2ddtse', NULL, value = 1.30059647460184, min = 0, width = '100%'),
      numericInput('indic2pcbmean', NULL, value = 71.0791428571429, min = 0, width = '100%'),
      numericInput('indic2pcbse', NULL, value = 36.3098108973698, min = 0, width = '100%')
    )
  ),
  ...
  fluidRow(
    ...
    splitLayout(cellWidths = wds, 
      ...
      numericInput('indic3chlormean', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic3chlorse', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic3dieldmean', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic3dieldse', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic3ddtmean', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic3ddtse', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic3pcbmean', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic3pcbse', NULL, value = NULL, min = 0, width = '100%')
    )
  ),
  ...
  fluidRow(
    ...
    splitLayout(cellWidths = wds, 
      ...
      numericInput('indic4chlormean', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic4chlorse', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic4dieldmean', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic4dieldse', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic4ddtmean', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic4ddtse', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic4pcbmean', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic4pcbse', NULL, value = NULL, min = 0, width = '100%')
    )
  ),
  ...
  fluidRow(
    ...
    splitLayout(cellWidths = wds, 
      ...
      numericInput('indic5chlormean', NULL, value = 2.5275, min = 0, width = '100%'),
      numericInput('indic5chlorse', NULL, value = 0.4157433102288, min = 0, width = '100%'),
      numericInput('indic5dieldmean', NULL, value = 0.25, min = 0, width = '100%'),
      numericInput('indic5dieldse', NULL, value = 0, min = 0, width = '100%'),
      numericInput('indic5ddtmean', NULL, value = 7.283, min = 0, width = '100%'),
      numericInput('indic5ddtse', NULL, value = 2.51069636948402, min = 0, width = '100%'),
      numericInput('indic5pcbmean', NULL, value = 1.9195, min = 0, width = '100%'),
      numericInput('indic5pcbse', NULL, value = 0.976160911428029, min = 0, width = '100%')
    )
  ),
  ...
  fluidRow(
    ...
    splitLayout(cellWidths = wds, 
      ...
      numericInput('indic6chlormean', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic6chlorse', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic6dieldmean', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic6dieldse', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic6ddtmean', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic6ddtse', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic6pcbmean', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic6pcbse', NULL, value = NULL, min = 0, width = '100%')
    )
  ),
  ...
  fluidRow(
    ...
    splitLayout(cellWidths = wds, 
      ...
      numericInput('indic7chlormean', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic7chlorse', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic7dieldmean', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic7dieldse', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic7ddtmean', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic7ddtse', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic7pcbmean', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic7pcbse', NULL, value = NULL, min = 0, width = '100%')
    )
  ),
  ...
  fluidRow(
    ...
    splitLayout(cellWidths = wds, 
      ...
      numericInput('indic8chlormean', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic8chlorse', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic8dieldmean', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic8dieldse', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic8ddtmean', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic8ddtse', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic8pcbmean', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic8pcbse', NULL, value = NULL, min = 0, width = '100%')
    )
  ),
  ...
  fluidRow(
    ...
    splitLayout(cellWidths = wds, 
      ...
      numericInput('indic9chlormean', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic9chlorse', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic9dieldmean', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic9dieldse', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic9ddtmean', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic9ddtse', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic9pcbmean', NULL, value = NULL, min = 0, width = '100%'),
      numericInput('indic9pcbse', NULL, value = NULL, min = 0, width = '100%')
    )
  ),
  ...
  fluidRow(
    ...
    splitLayout(cellWidths = wds, 
      renderText(NULL),
      numericInput('sedchlormean', NULL, value = 0.5, min = 0, width = '100%'),
      numericInput('sedchlorse', NULL, value = 0, min = 0, width = '100%'),
      numericInput('seddieldmean', NULL, value = 0.5, min = 0, width = '100%'),
      numericInput('seddieldse', NULL, value = 0, min = 0, width = '100%'),
      numericInput('sedddtmean', NULL, value = 1.19166666666667, min = 0, width = '100%'),
      numericInput('sedddtse', NULL, value = 0.765187658537288, min = 0, width = '100%'),
      numericInput('sedpcbmean', NULL, value = 1.33454545454546, min = 0, width = '100%'),
      numericInput('sedpcbse', NULL, value = 1.60216108332035, min = 0, width = '100%')
    )
  )
...
output$plo_cmp <- renderPlotly({
  ...
  # bsaf from dst
  dst <- read.csv('data/raw/bsaf_dst.csv', check.names = F, stringsAsFactors = F) %>% 
    dplyr::select(-`Contaminant class`) %>% 
    gather('species', 'dst_bsaf', -Contaminant) %>% 
    mutate(
      species = case_when(
        grepl('^Diet\\s\\-\\s', species) ~ gsub('^Diet\\s\\-\\s', '', species), 
        grepl('[0-9]', species) ~ gsub('^.*([0-9]).*$', 'indic\\1', species), 
        T ~ species
      )
    )
  ...
  # bsaf from here
  shi <- bsaf %>% 
    gather('Contaminant', 'shi_bsaf', -species) %>% 
    filter(!species %in% 'Sediment')

  toeval <- dst %>% 
    inner_join(shi, by = c('species', 'Contaminant')) %>% 
    # filter(species %in% 'indic1') %>% 
    filter(Contaminant %in% !!cntbsaf)

  p <- ggplot(toeval, aes(x = shi_bsaf, y = dst_bsaf, label = species)) + 
    geom_point() + 
...
```
```{r}
plotlyOutput('plo_cmp', width = '500px', height = '500px')
```
