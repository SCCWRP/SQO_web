...
wellPanel(id = "contamdat", style = "overflow-y:scroll; max-height: 300px; background-color:#daf1da",
  ...
  # doc conc in water       
  fluidRow(
    column(2, h6('Chlordanes')),
    column(2, h6('alphaChlordane')),
    column(2, numericInput('alphaChlordane_sed', NULL, value = 1, min = 0, width = '100%')),
    column(2, numericInput('alphaChlordane_sur', NULL, value = 1, min = 0, width = '100%')),
    column(2, numericInput('alphaChlordane_por', NULL, value = 1, min = 0, width = '100%'))
  )
