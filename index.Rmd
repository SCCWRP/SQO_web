...
output$dlindicsum <- downloadHandler(
  filename = function(){'indicsum.csv'},
...
output$dlplobsaf <- downloadHandler(
  filename = function(){'dlplobsaf.png'},
  content = function(file){
...
output$dltabbsaf <- downloadHandler(
  filename = function(){'dltabbsaf.csv'},
  content = function(file){
...
output$dlsqosum <- downloadHandler(
  filename = function(){'dlsqosum.csv'},
  content = function(file){
...
output$dlmcssum <- downloadHandler(
  filename = function(){'dlmcssum.csv'},
  content = function(file){
...
output$dlmcsres <- downloadHandler(
  filename = function(){'dlmcsres.csv'},
  content = function(file){
...
output$dlcalccont <- downloadHandler(
  filename = function(){'dlcalccont.csv'},
  content = function(file){
...
output$dlconstantstmpl <- downloadHandler(
  filename = function(){'constants.csv'},
  content = function(file){
...
output$dlmcsparmstmpl <- downloadHandler(
  filename = function(){'mcsparms.csv'},
  content = function(file){
...
```{r}
selectInput('inptyp', label = 'Select input type:', choices = c('Manual entry', 'File upload'))
```
