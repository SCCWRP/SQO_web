...
looptxt <- reactiveValues()
output$showProgressText <- renderText(reactiveValuesToList(looptxt))  
...
observeEvent(input$run, {
  ...
  for (icontam in 1:ncontam){
    ...
    for (ispecies in 1:nspecies) {
      ...
      # log
      looptxt[[as.character(ispecies)]] <- paste0('Contaminant', icontam, 'of', ncontam, '\n\tspecies', ispecies, 'of', nspecies)
